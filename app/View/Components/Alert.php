    ...
    public function __construct($type)
    {
        switch($type) {
            ...
            case 'success':
                ...
                break;
            case 'warning':
                $this->class = 'p-4 mb-4 text-sm text-yellow-800 rounded-lg bg-yellow-50 dark:bg-gray-800 dark:text-yellow-400';
                break;
            case 'danger':
                $this->class = 'p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400';
                break;
            default:
                $this->class = 'p-4 mb-4 text-sm text-gray-800 rounded-lg bg-gray-50 dark:bg-gray-800 dark:text-gray-400';
        }
    }
