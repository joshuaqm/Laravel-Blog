          ...
          <header class="mb-4 lg:mb-6 not-format">
              <address class="flex items-center mb-6 not-italic">
                  <div class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white">
                      ...
                      <flux:avatar :name="$post->user->name" class="mr-4" size="xl" circle />

                      <div>
                            <a href="#" rel="author" class="text-xl font-bold text-gray-900 dark:text-white">
                                {{ $post->user->name }}
                            </a>
                          <p class="text-base text-gray-500 dark:text-gray-400">Desarrollador Web</p>
                          <p class="text-base text-gray-500 dark:text-gray-400">
                            <time pubdate datetime="2022-02-08" title="February 8th, 2022">{{ $post->published_at->format('M. d, Y') }}</time>
                        </p>
                      </div>
                  </div>
              </address>
      ...
      <div class="grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
        @foreach ($relatedPosts as $relatedPost)
            <article class="max-w-xs">
                ...
                <p class="mb-4 text-gray-500 dark:text-gray-400">{{ Str::limit($relatedPost->excerpt, 100) }}</p>
